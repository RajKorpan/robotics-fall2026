...
LABELS={"intro":"Introduction","concepts":"Responsible design","background":"System model","playground":"Policy sandbox","lab":"Missions","final_submission":"Submit"}
...
def render_progress(st):
    ...
    with st.sidebar.expander("Lab navigation",expanded=True):
        for stage in LAB.stages:
            ...
            if st.button(LABELS[stage],key="nav."+stage,disabled=not unlocked or stage==current_stage(st),width="stretch"): set_stage(st,stage)
