    ...
    st.markdown(
        ...
        <div class="intro-hero">
            <div class="intro-copy">
                <h1>Week 14: Reinforcement Learning with an Inverted Pendulum</h1>
...
def run_streamlit_app() -> None:
    ...
    st.set_page_config(
        page_title="Week 14: Reinforcement Learning",
        page_icon="RL",
        layout="wide",
    ...
    if stage == "algorithm_demo":
        ...
        finish_streamlit_autosave(st)
        return
    st.title("Week 14: Reinforcement Learning with an Inverted Pendulum")
